    ...
    <li>- Elegant Packaging – Ideal for Gifting</li>
            ...
            <section className="similar" style={{minHeight: "20vh"}}>
                ...
                <div className="grid" style={{gap:"1.5vw",minWidth: "80vw", margin: "3vh 0"}}>
                    ...
                    <div className="card1">
                        ...
                        <Image src="/chiropractic.jpg" alt="Chiropractic treatment" width={300} height={200} />
                    </div>     
                    <div className="card1" style={{marginRight: "3vw"}}>
                        ...
                        <Image src="/massage.jpg" alt="Massage treatment" width={300} height={200} />
                    </div> 
            ...
            <section className="more-detail" style={{minHeight:"75vh"}}>
                ...
                <div className="l-content" style={{minHeight:"25vh", backgroundColor:"rgba(0, 0, 0, 0.05)"}}>
                    ...
                    <Image src="/aroma.jpg" alt="Aroma therapy" width={500} height={333} style={{width: "500px", height: "auto"}} />
                </div>
                <div className="l-content" style={{minHeight:"25vh"}}>
                <Image src="/head.jpg" alt="Head massage" width={500} height={333} style={{width: "500px", height: "auto"}} />
                    <div className="txt">
