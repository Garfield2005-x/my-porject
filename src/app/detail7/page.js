...
const products = [
  { id: 1, name: "Candle", price: 900,image: "/Candle.jpg", },
            ...
            <section className="info">
                ...
                <div className="detail">
                    ...
                    <div className="detail-text">
                       <h2>Price : 990 baht</h2>
<h3>Detail</h3>
<p>Key benefits:</p>
<ul>
    <li>- Creates a Calming & Cozy Atmosphere</li>
    <li>- Enhances Mood & Reduces Stress</li>
    <li>- Aromatherapy Benefits for Mind & Body</li>
    <li>- Hand-Poured with Premium Wax & Essential Oils</li>
    <li>- Long-Lasting, Clean Burn</li>
    <li>- Stylish Design Perfect for Home Decor or Gifting</li>
</ul>
            ...
            <section className="similar" style={{minHeight: "20vh"}}>
                ...
                <div className="grid" style={{gap:"1.5vw",minWidth: "80vw", margin: "3vh 0"}}>
                    <div className="card1">
                        ...
                        <Image src="/Facial.jpg" alt="Chiropractic Service" width={300} height={200} />
                    </div>    
                    </div>
                    <div className="card1">
                        <div className="overlay">
                        ...
                        <Image src="/chiropractic.jpg" alt="Chiropractic Service" width={300} height={200} />
                    </div>     
                    <div className="card1" style={{marginRight: "3vw"}}>
                        ...
                        <Image src="/massage.jpg" alt="Massage Service" width={300} height={200} />
                    </div> 
